...
class ArrayHelper {
     ...
     * @throws wp_die if the $direction or $sortFlag parameters do not have
    ...
    public static function multisort(&$array, $key, $direction = SORT_ASC, $sortFlag = SORT_REGULAR) {
        ...
        if (is_scalar($direction)) {
            ...
            wp_die('The length of $direction parameter must be the same as that of $keys.');
        }
        if (is_scalar($sortFlag)) {
            $sortFlag = array_fill(0, $n, $sortFlag);
        } elseif (count($sortFlag) !== $n) {
            wp_die('The length of $sortFlag parameter must be the same as that of $keys.');
        }
        $args = [];
     ...
     * @throws wp_die if `$haystack` is neither traversable nor an array.
    ...
    public static function isIn($needle, $haystack, $strict = false) {
        if ($haystack instanceof \Traversable) {
          ...
          wp_die('Argument $haystack must be an array or implement Traversable');
        }
     ...
     * @param bool $strict Whether to enable strict (`===`) comparison.
     * @throws wp_die if `$haystack` or `$needles` is neither traversable nor an array.
    ...
    public static function isSubset($needles, $haystack, $strict = false) {
        if (is_array($needles) || $needles instanceof \Traversable) {
          ...
          wp_die('Argument $needles must be an array or implement Traversable');
        }
    }
