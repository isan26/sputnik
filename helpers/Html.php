...
/**
 * Clase readaptaba de Yii2 baseHtml
 */
class Html {
    ...
    public static function checkboxList($name, $selection = null, $items = [], $options = []) {
        ...
        foreach ($items as $value => $label) {
            $checked = $selection !== null &&
                    (!ArrayHelper::isTraversable($selection) && !strcmp($value, $selection) || ArrayHelper::isTraversable($selection) && ArrayHelper::isIn($value, $selection));
            if ($formatter !== null) {
    ...
    public static function activeLabel($model, $attribute, $options = []) {
        $for = static::getInputId($model, $attribute);
        $label = static::encode($model->getAttributeLabel($attribute));
    ...
    public static function getAttributeName($attribute) {
        if (preg_match('/(^|.*\])([\w\.]+)(\[.*|$)/', $attribute, $matches)) {
            ...
            wp_die('Attribute name must contain word characters only.');
        }
    }
